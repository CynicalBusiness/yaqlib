...
export type RequestHeaderInput = Record<string, string | RequestHeaderValue> | Iterable<RequestHeaderEntry | Record<string, string | RequestHeaderValue>>;
export interface RequestOptionsInput extends Omit<RequestOptions, "headers" | "method"> {
    /**
...
export type RequestResponseInput<TBody = unknown> = Omit<RequestResponse<TBody>, "headersObject" | "success" | "request" | "statusText"> & Partial<Pick<RequestResponse<TBody>, "statusText">> & {
    url: string;
};
